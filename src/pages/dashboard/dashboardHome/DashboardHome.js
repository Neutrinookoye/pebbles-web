					...
					<div className='dashboardmain__bookingbottom'>
						...
						<ul className='dashboardmain__list'>
							<li className='dashboardmain__item'>
								<span className='dashboardmain__item--name'>Adults</span>
								<span>3</span>
							</li>
							<li className='dashboardmain__item'>
								<span className='dashboardmain__item--name'>Children</span>
								<span>3</span>
							</li>
							<li className='dashboardmain__item'>
								<span className='dashboardmain__item--name'>Roomes</span>
								<span>3</span>
							</li>
						</ul>
					</div>
				...
				<div className='dashboardmain__booking dashboardmain__booking--color '>
					...
					<div className='dashboardmain__bookingbottom dashboardmain__bookingbottom--grid'>
						...
						<div className='dashboardblue__list'>
							<ul className='dashboardmain__list'>
								<li className='dashboardmain__item'>
									<span className='dashboardmain__item--name'>No of days</span>
									<span>19</span>
								</li>
								<li className='dashboardmain__item'>
									<span className='dashboardmain__item--name'>Children</span>
