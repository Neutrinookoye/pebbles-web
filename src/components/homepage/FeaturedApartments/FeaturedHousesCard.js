      ...
      {houses.map((house) => (
        <div className="post-card" key={house.id}>
          <div className="post-image">
            <img src={house.postImage} alt="" />
          </div>
          <div className="body">
            <p className="post-title">{house.postTitle}</p>
            <p className="price">{house.apartmentPrice}</p>

            <div className="houses">
              <div className="amenities">
                <span className="bedroom">{house.bedroomNo} bedroom</span>
                <span className="toilet">
                  <FontAwesomeIcon className="dot" icon={faCircle} />{" "}
                  {house.toiletNo} toilet
                </span>
                <span className="parlor">
                  <FontAwesomeIcon className="dot" icon={faCircle} />{" "}
                  {house.parlorNo} parlor
                </span>
              </div>
              <div className="user">
                ...
                <div className="user-details">
                  ...
                  <p className="location">{house.apartmentLocation}</p>
                </div>
              </div>
            </div>
          </div>
